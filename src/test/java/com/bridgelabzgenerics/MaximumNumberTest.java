...
public class MaximumNumberTest {
    ...
    // Test case for finding and printing max Integer with more than three elements
    @Test
    public void givenMultipleIntegers_ShouldReturnAndPrintMaximumInteger() {
    ...
    // Test case for finding and printing max Float with more than three elements
    @Test
    public void givenMultipleFloats_ShouldReturnAndPrintMaximumFloat() {
    ...
    // Test case for finding and printing max String with more than three elements
    @Test
    public void givenMultipleStrings_ShouldReturnAndPrintMaximumString() {
